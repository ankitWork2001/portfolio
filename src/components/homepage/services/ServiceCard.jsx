...
export default function ServiceCard({
  ...
  return (
    ...
    >
      ...
      {/* Card container */}
      <div className="relative sm:w-[422px] md:w-[355px] lg:w-[275px] h-[425px] pl-3 flex flex-col items-start pt-4 lg:left-[56px]  overflow-hidden">
        ...
        {/* Description */}
        <p className="mt-4 w-fit lg:w-[195px] font-semibold text-left z-10">
          {description}
        </p>
