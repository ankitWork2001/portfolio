    ...
    <>
      ...
      >
        <p className="italic text-[#D4D4D4] text-sm sm:text-base md:text-lg leading-relaxed sm:leading-loose font-medium px-4 sm:px-0">
          At <span className="text-white font-semibold">VaishaliTech</span>, we are dedicated to
          providing innovative and comprehensive technology solutions tailored to meet the
          unique needs of our clients. From website development and UI/UX design to network
          marketing and brand strategy, we offer services that empower businesses to succeed in
          the digital age. Whether you're looking to establish an online presence, enhance your
          user experience, or develop effective marketing strategies — we’re here to support your
          growth and bring your vision to life.
        </p>
      </motion.div>
    </>
  );
