...
const DigitalMarketing = () => (
  <div className='bg-blue-950 flex w-full overflow-hidden flex-col md:flex-row py-20 lg:py-30 justify-around'>
    <div className='relative w-full max-w-lg h-auto my-10 md:my-0 right-6 order-1 md:order-2'>
      ...
      <img src={image} alt="Website" className='relative left-17 lg:left-22 top-13 z-10 w-[70%] lg:w-[83%] h-auto object-contain' />
    </div>
    <div className='space-y-5 relative left-5 max-w-xl order-2 md:order-1 mt-12 md:mt-0'>
      <h1 className='text-white font-bold text-[2rem] md:text-[2.875rem]'>Digital Marketing</h1>
