...
const pointsData2 = [
  "First impressions are shaped within seconds — a strong UI builds instant trust.",
  "Thoughtful UX ensures users can navigate effortlessly and find what they need.",
  "Good design reduces bounce rates and keeps visitors engaged longer.",
  "It reflects your brand’s professionalism, credibility, and attention to detail.",
  "Ultimately, UI/UX turns casual visitors into satisfied, loyal customers."
]
    ...
    <section>
      <div className='bg-blue-950 py-18 md:py-35 px-10 flex flex-col md:flex-row justify-around '>
        ...
        <div className='space-y-5 max-w-xl order-2 md:order-1 mt-12 md:mt-0'>
          <BouncyText
            text={"Why UI/UX Design ?"}
            className="text-white font-bold text-[2rem] md:text-[2.875rem]"
          />
          <h2 className='text-[#A0AEC0] font-bold text-[25px]'>Great UI/UX isn’t just design—it builds trust, boosts engagement, and turns visitors into loyal customers.</h2>
